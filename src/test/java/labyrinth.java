...
import com.sqli.nespresso.labyrinth.exception.DoorAlreadyClosedException;
...
public class LabyrinthShould {
	...
	/**
	 * each letter represent a room each | represent a gate between two room
	 ...
	 */
	@Test
	public void be_Walkable_Till_The_End() throws IllegalMoveException,
			ClosedDoorException {
	...
	@Test(expected = IllegalMoveException.class)
	public void refuse_Move_Without_Path() throws IllegalMoveException,
			ClosedDoorException {
		Labyrinth labyrinth = new Labyrinth("A$B", "A$C", "B$D");
		labyrinth.popIn("A");
		labyrinth.walkTo("B");
	...
	@Test
	public void allow_Cyclic_Path() throws IllegalMoveException,
			ClosedDoorException {
		Labyrinth labyrinth = new Labyrinth("A$B", "A$C", "C|E", "B$D", "B|E",
				"E$F", "D$F", "F|G");
		labyrinth.popIn("A");
	...
	@Test
	public void allow_Back_And_Forth() throws IllegalMoveException,
			ClosedDoorException {
		Labyrinth labyrinth = new Labyrinth("A$B", "A$C", "C|E", "B$D", "B|E",
				"E$F", "D$F", "F|G");
		labyrinth.popIn("A");
	...
	public void not_Allow_Closed_Door_Crossing()
			throws DoorAlreadyClosedException, IllegalMoveException,
			ClosedDoorException {
		Labyrinth labyrinth = new Labyrinth("A$B", "A$C", "C|E", "B$D", "B|E",
				"E$F", "D$F", "F|G");
		labyrinth.popIn("A");
	...
	@Test
	public void follow_Walker() throws IllegalMoveException,
			ClosedDoorException {
		Labyrinth labyrinth = new Labyrinth("A$B", "A$C", "B$D", "D$E", "D$F",
				"F$H", "D$F");
		labyrinth.popIn("A");
		labyrinth.walkTo("B");
